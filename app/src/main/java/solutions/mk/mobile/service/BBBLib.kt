...
//    @SuppressLint("NewApi") override fun onCreate(savedInstanceState: Bundle?) {
//        super.onCreate(savedInstanceState)
//        setContentView(R.layout.activity_main)
//        Cancel = findViewById<MaterialButton>(R.id.Cancel)
//        GetImage = findViewById<MaterialButton>(R.id.GetImage)
...
//            }
//        })
//        GetImage.setOnClickListener(object : OnClickListener() {
//            fun onClick(v: View?) {
...
//        if (GetImage != null) {
//            GetImage!!.isEnabled = grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED
//        }
//    }
//
